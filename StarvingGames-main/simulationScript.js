...
window.onload = function() {
    ...
    setInterval(function updateContextBoxHeading(){
        ...
        document.getElementById("timeText").innerText = `Time: ${hours.toString()}:${minutes < 10 ? "0" + minutes.toString():  minutes.toString()}:${seconds < 10 ? "0" + seconds.toString(): seconds.toString()}`;
